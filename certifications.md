...
<img align="left" src="{{ '/assets/img/Microsoft_SQL_Server_2025_icon.svg' | relative_url }}" style="height: 35px; width: 40px;" alt="SqlServer">
...
<img align="left" src="{{ '/assets/img/fabric_48_color.svg' | relative_url }}" style="height: 35px; width: 40px;" alt="Fabric">
...
<img align="left" src="{{ '/assets/img/PowerBI_scalable.svg' | relative_url }}" style="height: 35px; width: 40px;" alt="PowerBI">
...
``2024-01`` &emsp; [Microsoft Power Up Program](https://www.credly.com/badges/43f0c637-cbb6-4ce2-b9d6-dcfd32cdd764){:target="_blank" rel="noopener"} - 3-month course  

***

<img align="left" src="{{ '/assets/img/qlik-old.svg' | relative_url }}" style="height: 35px; width: 40px;" alt="Qlik">
...
<img align="left" src="{{ '/assets/img/database.svg' | relative_url }}" style="height: 35px; width: 40px;" alt="Database">
...
``2025-04`` &emsp; [Machine Learning with Python](https://freecodecamp.org/certification/miroslav_gencur/machine-learning-with-python-v7){:target="_blank" rel="noopener"} – *freeCodeCamp*  
``2024-05`` &emsp; [Foundational C# with Microsoft](https://freecodecamp.org/certification/miroslav_gencur/foundational-c-sharp-with-microsoft){:target="_blank" rel="noopener"} – *freeCodeCamp*   
``2023-08`` &emsp; [Data Analysis with Python](https://freecodecamp.org/certification/miroslav_gencur/data-analysis-with-python-v7){:target="_blank" rel="noopener"} – *freeCodeCamp*  
``2023-07`` &emsp; [Scientific Computing with Python](https://freecodecamp.org/certification/miroslav_gencur/scientific-computing-with-python-v7){:target="_blank" rel="noopener"} – *freeCodeCamp*  
